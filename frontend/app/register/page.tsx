    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 gradient-hero relative overflow-hidden">
        ...
        <div className="relative flex flex-col justify-center items-center w-full p-12 text-white">
          <div className="text-center max-w-md">
            ...
            <h2 className="text-2xl font-bold mb-3">Bergabung dengan Kami</h2>
            <p className="text-[#ccfbf1] leading-relaxed mb-8">
              Daftar sekarang dan nikmati kemudahan reservasi dokter secara online.
            </p>
            ...
            <div className="space-y-4 text-left">
              <div className="flex items-center gap-4 p-4 bg-white/10 rounded-xl backdrop-blur">
                ...
                <div>
                  <p className="font-semibold">Gratis Tanpa Biaya</p>
                  <p className="text-sm text-[#ccfbf1]">Pendaftaran tanpa biaya tersembunyi</p>
                </div>
              </div>
              <div className="flex items-center gap-4 p-4 bg-white/10 rounded-xl backdrop-blur">
                <div className="w-10 h-10 rounded-lg bg-white/20 flex items-center justify-center">
                ...
                <div>
                  <p className="font-semibold">Data Terjamin Aman</p>
                  <p className="text-sm text-[#ccfbf1]">Informasi kesehatan dilindungi</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-8 py-12">
        <div className="w-full max-w-md animate-slide-up opacity-0" style={{ animationDelay: '0.1s', animationFillMode: 'forwards' }}>
          ...
          {/* Header */}
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-[#1a1d23] mb-2">Daftar Akun Baru</h1>
            <p className="text-[#6b7280]">Lengkapi data di bawah untuk mendaftar</p>
          </div>
