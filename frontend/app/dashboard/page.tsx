    ...
    <div className="min-h-screen bg-[#fafbfc]">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          ...
          <Link href="/patient/dashboard" className="card card-hover p-5 flex items-center gap-4 animate-slide-up opacity-0" style={{ animationDelay: '0.45s', animationFillMode: 'forwards' }}>
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#f3e8ff] to-[#e9d5ff] flex items-center justify-center text-[#9333ea]">
              <Icons.Folder />
            </div>
            <div>
              <h3 className="font-bold text-[#1a1d23]">Rekam Medis</h3>
              <p className="text-sm text-[#6b7280]">EHR & kesehatan saya</p>
            </div>
          </Link>
